...
{$PACKRECORDS C}
 ...
 { Pointers to basic pascal types, inserted by h2pas conversion program.}
    ...
    { The calculated values in this structure are calculated by SDL_OpenAudio  }
     ...
     SDL_AudioSpec = record
  	   ...
  	   Once the callback returns, the buffer will no longer be valid.
          ...
          callback : procedure (var userdata; stream:pByte; len:Int);cdecl;
          userdata : pointer;
       end;
  ...
  function SDL_OpenAudio(desired:pSDL_AudioSpec; var obtained:SDL_AudioSpec):Int;cdecl;
  ...
  procedure SDL_PauseAudio(pause_on:Int);cdecl;
  ...
  function SDL_BuildAudioCVT(cvt:pSDL_AudioCVT; src_format:Uint16; src_channels:Uint8; src_rate:Int; dst_format:Uint16;
  ...
  function SDL_ConvertAudio(cvt:pSDL_AudioCVT):Int;cdecl;
  ...
  procedure SDL_MixAudio(dst:pByte; src:pByte; len:Uint32; volume:Int);cdecl;
  ...
  function SDL_OpenAudio(desired:pSDL_AudioSpec; var obtained:SDL_AudioSpec):Int;cdecl;external 'SDL';

  Function SDL_GetAudioStatus: SDL_audiostatus;cdecl;external 'SDL';

  procedure SDL_PauseAudio(pause_on:Int);cdecl;external 'SDL';
  ...
  function SDL_BuildAudioCVT(cvt:pSDL_AudioCVT; src_format:Uint16; src_channels:Uint8; src_rate:Int; dst_format:Uint16; 
             dst_channels:Uint8; dst_rate:Int):Int;cdecl;external 'SDL';

  function SDL_ConvertAudio(cvt:pSDL_AudioCVT):Int;cdecl;external 'SDL';

  procedure SDL_MixAudio(dst:pByte; src:pByte; len:Uint32; volume:Int);cdecl;external 'SDL';
