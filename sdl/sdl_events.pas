...
{$PACKRECORDS C}
  ...
  { Predefined event masks }
    ...
    function SDL_PeepEvents(var events:SDL_Event; numevents:Int; action:SDL_eventaction; mask:Uint32):Int;cdecl;

    { Polls for currently pending events, and returns 1 if there are any pending
       events, or 0 if there are none available.  If 'event' is not nil, the next
       event is removed from the queue and stored in that area.
      }
    function SDL_PollEvent(event:pSDL_Event):Int;cdecl;

    { Waits indefinitely for the next available event, returning 1, or 0 if there
       was an error while waiting for events.  If 'event' is not nil, the next
       event is removed from the queue and stored in that area.
      }
    function SDL_WaitEvent(event:pSDL_Event):Int;cdecl;
    ...
    function SDL_PushEvent (var event: SDL_Event):Int;cdecl;
    ...
    type
       SDL_EventFilter = function (event:pSDL_Event):Int;cdecl;
    {
    ...
    function SDL_EventState(eventtype:Uint8; state:Int):Uint8;cdecl;
  ...
  implementation
    ...
    function SDL_PeepEvents(var events:SDL_Event; numevents:Int; action:SDL_eventaction; mask:Uint32):Int;cdecl;external 'SDL';

    function SDL_PollEvent(event:pSDL_Event):Int;cdecl;external 'SDL';

    function SDL_WaitEvent(event:pSDL_Event):Int;cdecl;external 'SDL';

    function SDL_PushEvent (var event: SDL_Event):Int;cdecl;external 'SDL';
    ...
    function SDL_EventState(eventtype:Uint8; state:Int):Uint8;cdecl;external 'SDL';
