...
{$PACKRECORDS C}
  ...
  function SDL_Init(flags:Uint32):Int;cdecl;

  { This function initializes  specific SDL subsystems }
  function SDL_InitSubSystem(flags:Uint32):Int;cdecl;
...
{$IFDEF LINUX}
  {$LINKLIB pthread}
{$ENDIF}
  function SDL_Init(flags:Uint32):Int;cdecl;external 'SDL';

  function SDL_InitSubSystem(flags:Uint32):Int;cdecl;external 'SDL';
