...
{$PACKRECORDS C}
 ...
 { Pointers to basic pascal types, inserted by h2pas conversion program.}
  ...
  function SDL_GetMouseState(var x:Int; var y:Int):Uint8;cdecl;
  ...
  function SDL_GetRelativeMouseState(var x:Int; var y:Int):Uint8;cdecl;
  ...
  function SDL_CreateCursor(data:pByte; mask:pByte; w:Int; h:Int; hot_x:Int;
             hot_y:Int):pSDL_Cursor;cdecl;
  ...
  function SDL_ShowCursor(toggle:Int):LongBool;cdecl;
  ...
  function SDL_GetMouseState(var x:Int; var y:Int):Uint8;cdecl;external 'SDL';

  function SDL_GetRelativeMouseState(var x:Int; var y:Int):Uint8;cdecl;external 'SDL';

  procedure SDL_WarpMouse(x:Uint16; y:Uint16);cdecl;external 'SDL';

  function SDL_CreateCursor(data:pByte; mask:pByte; w:Int; h:Int; hot_x:Int;
             hot_y:Int):pSDL_Cursor;cdecl;external 'SDL';
  ...
  function SDL_ShowCursor(toggle:Int):longBool;cdecl;external 'SDL';
