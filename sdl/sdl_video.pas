...
{$PACKRECORDS C}
 ...
 { Pointers to basic pascal types, inserted by h2pas conversion program.}
...

  {
    ...
    { This structure should be treated as read-only, except for 'pixels',
       ...
       SDL_blit = function (src:PSDL_Surface; srcrect:pSDL_Rect;
                            dst:PSDL_Surface; dstrect:pSDL_Rect):Int;cdecl;
    ...
    function SDL_VideoModeOK(width:Int; height:Int; bpp:Int; flags:Uint32):Int;cdecl;
    ...
    function SDL_SetVideoMode(width:Int; height:Int; bpp:Int; flags:Uint32):PSDL_Surface;cdecl;
    ...
    procedure SDL_UpdateRects(screen:pSDL_Surface; numrects:Int; var rects:SDL_RectArray);cdecl;
    ...
    function SDL_Flip(screen:pSDL_Surface):Int;cdecl;
    ...
    function SDL_SetColors(surface:pSDL_Surface; var colors:SDL_ColorArray; firstcolor:Int; ncolors:Int):Int;cdecl;
    ...
    function SDL_SetPalette(surface:pSDL_Surface; flags: Int; var colors:SDL_ColorArray; firstcolor:Int; ncolors:Int):longBool;cdecl;
    ...
    function SDL_CreateRGBSurface(flags:Uint32; width:Int; height:Int; depth:Int; Rmask:Uint32;
               Gmask:Uint32; Bmask:Uint32; Amask:Uint32):PSDL_Surface;cdecl;

    { This is an alias for SDL_CreateRGBSurface}
    function SDL_AllocSurface(flags:Uint32; width:Int; height:Int; depth:Int; Rmask:Uint32;
               Gmask:Uint32; Bmask:Uint32; Amask:Uint32):PSDL_Surface;

    function SDL_CreateRGBSurfaceFrom(pixels:pointer; width:Int; height:Int; depth:Int; pitch:Int;
    ...
    function SDL_LockSurface(surface:pSDL_Surface):Int;cdecl;
    ...
    function SDL_SaveBMP_RW(surface:pSDL_Surface; dst:pSDL_RWops; freedst:LongBool):Int;cdecl;

    { Convenience macro -- save a surface to a file  }
    function SDL_SaveBMP(surface: pSDL_Surface;filename:PChar) : Int;
    ...
    function SDL_SetColorKey(surface:pSDL_Surface; flag:Uint32; key:Uint32):Int;cdecl;
    ...
    function SDL_SetAlpha(surface:pSDL_Surface; flag:Uint32; alpha:Uint8):Int;cdecl;
    ...
    function SDL_BlitSurface(src:pSDL_Surface; srcrect:pSDL_Rect; dst:pSDL_Surface; dstrect:pSDL_Rect):Int;

    { This is the public blit function, SDL_BlitSurface, and it performs
       rectangle validation and clipping before passing it to SDL_LowerBlit
     }

    function SDL_UpperBlit(src:pSDL_Surface; srcrect:pSDL_Rect; dst:pSDL_Surface; dstrect:pSDL_Rect):Int;cdecl;

    { This is a semi-private blit function and it performs low-level surface
       blitting only.
     }
    function SDL_LowerBlit(src:pSDL_Surface; srcrect:pSDL_Rect; dst:pSDL_Surface; dstrect:pSDL_Rect):Int;cdecl;
    ...
    function SDL_FillRect(dst:pSDL_Surface; dstrect:pSDL_Rect; color:Uint32):Int;cdecl;
    ...
    function SDL_CreateYUVOverlay (width, height: Int; format: Uint32;
                                   display: pSDL_Surface): pSDL_Overlay;cdecl;  
 
    { Lock an overlay for direct access, and unlock it when you are done }
    function SDL_LockYUVOverlay(var overlay: SDL_Overlay):Int;cdecl;
    ...
    function SDL_DisplayYUVOverlay(var overlay:SDL_Overlay; var dstrect: SDL_Rect):Int;cdecl;
    ...
    function SDL_GL_LoadLibrary(path: PChar):Int;cdecl;

    { Get the address of a GL function (for extension functions) }
    procedure SDL_GL_GetProcAddress(proc: PChar);cdecl;

    { Set an attribute of the OpenGL subsystem before intialization. }
    function SDL_GL_SetAttribute(attr: SDL_GLattr; value: Int):Int;cdecl;
    ...
    function SDL_GL_GetAttribute (attr: SDL_GLattr; var value: Int):Int;cdecl;
  ...
  implementation
    ...
    function SDL_VideoModeOK(width:Int; height:Int; bpp:Int; flags:Uint32):Int;cdecl;external 'SDL';

    function SDL_ListModes(format:pSDL_PixelFormat; flags:Uint32):PSDL_RectArray;cdecl;external 'SDL';

    function SDL_SetVideoMode(width:Int; height:Int; bpp:Int; flags:Uint32):PSDL_Surface;cdecl;external 'SDL';

    procedure SDL_UpdateRects(screen:pSDL_Surface; numrects:Int; var rects:SDL_RectArray);cdecl;external 'SDL';

    procedure SDL_UpdateRect(screen:pSDL_Surface; x:Sint32; y:Sint32; w:Uint32; h:Uint32);cdecl;external 'SDL';

    function SDL_Flip(screen:pSDL_Surface):Int;cdecl;external 'SDL';
    ...
    function SDL_SetColors(surface:pSDL_Surface; var colors:SDL_ColorArray; firstcolor:Int; ncolors:Int):Int;cdecl;external 'SDL';

    function SDL_SetPalette(surface:pSDL_Surface; flags: Int; var colors:SDL_ColorArray; firstcolor:Int; ncolors:Int):longBool;cdecl;external 'SDL';
    ...
    function SDL_LockSurface(surface:pSDL_Surface):Int;cdecl;external 'SDL';
    ...
    function SDL_SaveBMP_RW(surface:pSDL_Surface; dst:pSDL_RWops; freedst:LongBool):Int;cdecl;external 'SDL';

    function SDL_SetColorKey(surface:pSDL_Surface; flag:Uint32; key:Uint32):Int;cdecl;external 'SDL';

    function SDL_SetAlpha(surface:pSDL_Surface; flag:Uint32; alpha:Uint8):Int;cdecl;external 'SDL';
    ...
    function SDL_UpperBlit(src:pSDL_Surface; srcrect:pSDL_Rect; dst:pSDL_Surface; dstrect:pSDL_Rect):Int;cdecl;external 'SDL';

    function SDL_LowerBlit(src:pSDL_Surface; srcrect:pSDL_Rect; dst:pSDL_Surface; dstrect:pSDL_Rect):Int;cdecl;external 'SDL';

    function SDL_FillRect(dst:pSDL_Surface; dstrect:pSDL_Rect; color:Uint32):Int;cdecl;external 'SDL';
    ...
    function SDL_LockYUVOverlay(var overlay: SDL_Overlay):Int;cdecl;external 'SDL';

    procedure SDL_UnlockYUVOverlay(var overlay: SDL_Overlay);cdecl;external 'SDL';

    function SDL_DisplayYUVOverlay(var overlay:SDL_Overlay; var dstrect: SDL_Rect):Int;cdecl;external 'SDL';

    procedure SDL_FreeYUVOverlay(var overlay: SDL_Overlay);cdecl;external 'SDL';

    function SDL_GL_LoadLibrary(path: PChar):Int;cdecl;external 'SDL';

    procedure SDL_GL_GetProcAddress(proc: PChar);cdecl;external 'SDL';

    function SDL_GL_SetAttribute(attr: SDL_GLattr; value: Int):Int;cdecl;external 'SDL';

    function SDL_GL_GetAttribute (attr: SDL_GLattr; var value: Int):Int;cdecl; external 'SDL';
