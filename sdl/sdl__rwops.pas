 ...
 { Pointers to basic pascal types, inserted by h2pas conversion program.}
  ...
  type
     ...
     SDL_RWops = record
          ...
          seek : function (context:pSDL_RWops; offset:Int; whence:Int):Int;cdecl;
          { Read up to 'num' objects each of size 'objsize' from the data
            source to the area pointed at by 'ptr'.
            Returns the number of objects read, or -1 if the read failed.
          }
          read : function (context:pSDL_RWops; var data; size:Int; maxnum:Int):Int;
          { Write exactly 'num' objects each of size 'objsize' from the area
            pointed at by 'ptr' to data source.
            Returns 'num', or -1 if the write failed.
          }
          write : function (context:pSDL_RWops; var data; size:Int; num:Int):Int;
          { Close and free an allocated SDL_FSops structure  }
          close : function (context:pSDL_RWops):Int;
          optype : Uint32;
          hidden : record
              case Int of
                 0 : ( stdio : record
  ...
  function SDL_RWFromFP(fp:Pointer; autoclose:Int):pSDL_RWops;cdecl;

  function SDL_RWFromMem(var mem; size:Int):pSDL_RWops;cdecl;

  function SDL_AllocRW:pSDL_RWops;cdecl;

  { Macros to easily read and write from an SDL_RWops structure  }
  function SDL_RWseek(ctx: pSDL_RWops;offset,whence : Int) : Int;

  function SDL_RWtell(ctx : pSDL_RWops) : Int;

  function SDL_RWread(ctx : pSDL_RWops; var data;size,n : Int) : Int;

  function SDL_RWwrite(ctx : pSDL_RWops; var data;size,n : Int) : Int;

  function SDL_RWclose(ctx : pSDL_RWops) : Int;

  implementation

  function SDL_RWFromFile(filename:pchar; mode:pchar):pSDL_RWops;cdecl;external 'SDL';

  function SDL_RWFromFP(fp:Pointer; autoclose:Int):pSDL_RWops;cdecl;external 'SDL';

  function SDL_RWFromMem(var mem; size:Int):pSDL_RWops;cdecl;external 'SDL';
