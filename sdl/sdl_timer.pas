...
{$PACKRECORDS C}
  ...
  function SDL_SetTimer(interval:Uint32; callback:SDL_TimerCallback):Int;cdecl;
  ...
  function SDL_SetTimer(interval:Uint32; callback:SDL_TimerCallback):Int;cdecl;external 'SDL';
